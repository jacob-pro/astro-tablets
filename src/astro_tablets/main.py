...
from astro_tablets.constants import HALO, FINGER, CUBIT
...
from astro_tablets.graphics.eclipse_score_plots import plot_eclipse_time_of_day_score, plot_eclipse_phase_length_score
