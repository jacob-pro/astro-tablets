...
from astro_tablets.generate.planet_events import OuterPlanetPhenomena, InnerPlanetPhenomena
from astro_tablets.query.abstract_query import AbstractQuery, SearchRange
from astro_tablets.query.abstract_tablet import AbstractTablet, YearToTest, Intercalary, MonthLength, MonthResult
...
from astro_tablets.query.lunar_eclipse_query import LunarEclipseQuery, ExpectedEclipseType, FirstContactTime, \
    FirstContactRelative
from astro_tablets.query.lunar_six_query import LunarSixQuery, LunarSix
...
class BM33066(AbstractTablet):
    ...
    def year_7(self, nisan_1: float) -> List[MonthResult]:
        month_i = self.repeat_month_with_alternate_starts(nisan_1, 1, self.year_7_month_1,
                                                          length=MonthLength.TWENTY_NINE)
